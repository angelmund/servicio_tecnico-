        ...
        fetch(url, {
            ...
            .then((data) => {
                if (data.message === "Error de validación") {
                    ...
                    agregarRegistroTablaEstadosReparacion(data);
                    resolve(data);
                } else if (data.Noti == 2) {
                    alertarExito(data.message);
                    actualizarTablaEstadosReparacion(data);
                    resolve(data);
                } else {
...
function agregarRegistroTablaEstadosReparacion(data) {
    const columnConfig = [
...
function actualizarTablaEstadosReparacion(data) {
    const columnConfig = [
        { field: "nombre", type: "text" },
        { field: "descripcion", type: "text" },
        { field: "activo", type: "badge", trueValue: true },
...
document.addEventListener("DOMContentLoaded", function () {
    if (!$.fn.DataTable.isDataTable("#datatables")) {
        tablaEstadosReparacion = initDataTable("datatables");
    } else {
        tablaEstadosReparacion = $("#datatables").DataTable();
    }
